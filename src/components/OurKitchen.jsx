            ...
            <div>
                ...
                <div>
                    <div className="pb-5 px-4 text-center">
                        ...
                        <p className="mowabluetext w-responsive mt-4 mx-auto text-justify font-weight-bold">
                            Last year, Meals On Wheels Atlanta (MOWA) prepared and delivered over 600,000 nutritious meals to our homebound senior neighbors and expect to provide an additional 100,000 more this year. But with hunger continuing to rise, and the escalated health risks from Covid-19, there are still 399 seniors on our (can’t) waitlist desperate for food. Could you imagine your mother, grandmother or grandfather just waiting for food?
                        </p>
                        <p className="mowabluetext w-responsive mt-4 mx-auto text-justify font-weight-bold">
